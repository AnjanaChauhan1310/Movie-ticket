...
<h4>Welcome to Admin dashboard!!</h4>
  ...
  <div class="row ">
    ...
    <div class="col-lg-4 mb-2">
        <div class="card">
          <div class="card-body">
            <div class="card-text">
              <h5>Palanpur Theater Seats</h5>
              <?php
                  $sql = "select sum(booking.person ) as 'total_person', booking.person 
                  from booking
                  inner join theater on theater.theaterid = booking.theaterid
                  where theater.location='Palanpur'";
                  $res  = mysqli_query($con, $sql);
                  $salesdata = mysqli_fetch_array($res);

              ?>
              <h6><?=$salesdata['total_person']?>/50</h6>
            </div>
          </div>
        </div>
     </div>
  ...
  <div class="col-lg-4 mb-2">
        <div class="card">
          <div class="card-body">
            <div class="card-text">
              <h5>Patan Theater Seats</h5>
              <?php
                  $sql = "select sum(booking.person ) as 'total_person', booking.person 
                  from booking
                  inner join theater on theater.theaterid = booking.theaterid
                  where theater.location='Patan'";
                  $res  = mysqli_query($con, $sql);
                  $salesdata = mysqli_fetch_array($res);
  ...
  <div class="col-lg-4 mb-2">
        <div class="card">
          <div class="card-body">
            <div class="card-text">
              <h5>Siddhpur Theater Seats</h5>
              <?php
                  $sql = "select sum(booking.person ) as 'total_person', booking.person 
                  from booking
                  inner join theater on theater.theaterid = booking.theaterid
                  where theater.location='Siddhpur'";
                  $res  = mysqli_query($con, $sql);
                  $salesdata = mysqli_fetch_array($res);
