...
<head>
    ...
    <title> Palanpur's Theater</title>
</head>
<body>
...
<div class="row">
  <div class="col-lg-6">
    <form action="surmandirA.php" method="post" enctype="multipart/form-data">
      
      <div class="form-group mb-4">
         <input type="text" class="form-control" name="theater_name" value="Surmandir Theater" >
      </div>
      ...
      <div class="form-group mb-4">
      <input type="text" class="form-control" name="location" value="Palanpur" placeholder="enter location" >
      </div>
  ...
  <div class="col-lg-6">
     ...
     <table class="table">
      ...
      <?php
      $sql = "SELECT surmandir.*, movies.title, categories.catname
      from surmandir
      inner join movies on movies.movieid = surmandir.movieid
...
if(isset($_POST['add'])){
  ...
  $sql = "INSERT INTO `surmandir`(`theater_name`,`timing`, `days`, `date`, `price`, `location`, `movieid`) VALUES ('$theater_name','$timing','$days','$date','$price','$location','$movieid')";
