...
<div class="row">
  <div class="col-lg-6">
    <form action="vijayA.php" method="post" enctype="multipart/form-data">
      
      <div class="form-group mb-4">
         <input type="text" class="form-control" name="theater_name" value="Vijay Cinema" >
      </div>
      ...
      <div class="form-group mb-4">
      <input type="text" class="form-control" name="location" value="Patan" placeholder="enter location" >
      </div>
  ...
  <div class="col-lg-6">
     ...
     <table class="table">
      ...
      <?php
      $sql = "SELECT vijay.*, movies.title, categories.catname
      from vijay
      inner join movies on movies.movieid = vijay.movieid
          ...
          <tr>
            ...
            <td>
             <!-- <a href="theater.php?editid=<?= $data['theaterid'] ?>" class="btn btn-primary"> Edit</a> -->
              <a href="vijayA.php?deleteid=<?= $data['theaterid'] ?>" class="btn btn-danger"> Delete</a>
          </td>
          </tr>
...
if(isset($_POST['add'])){
  ...
  $sql = "INSERT INTO `vijay`(`theater_name`,`timing`, `days`, `date`, `price`, `location`, `movieid`) VALUES ('$theater_name','$timing','$days','$date','$price','$location','$movieid')";
