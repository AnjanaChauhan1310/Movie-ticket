        ...
        <div class="col-lg-3 col-md-6 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up" data-aos-delay="100" > 
                                <div class="member">
                                  <div class="member-img">
                                    <img src="uploads/surmandir.jpg"  style="height:250px !important; width:250px !important;" alt="">
                                    ...
                                    <div class="social"> 
                                      <a href="surmandirA.php" target="_blank"  class="btn btn-primary" style="width:150px;">Add Movie</a>
                                  </div>
                                </div>
                               </div>
        </div>
                          ...
                          <div1 class="col-lg-3 col-md-6 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up" data-aos-delay="100" > 
                                 ...
                                 <div1 class="member-img"> 
                                    <img src="uploads/vijay.jpg"  style="height:250px !important; width:250px !important;" alt="">
                                    ...
                                    <p> Tirupati Market, Near Sidhhpur</p> <p>Cross Road, Patan</p><p> PINCODE : 384265</p>
                                     <div1 class="social"> 
                                      <a href="vijayA.php" target="_blank"  class="btn btn-primary" style="width:150px;">Add Movie</a>
                                     </div>
                                  </div>
                                  </div>
                           </div>
